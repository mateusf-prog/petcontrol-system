...
INSERT INTO tb_users(name, email, phone, birth_date, password, cpf_cnpj, zip_code, street, number, district, city, uf, role) VALUES ('Mateus', 'mateus@email.com', '12991978003', '1997-12-15', '123456', '19573556485', '12212700', 'Rua das Flores', '123', 'Centro', 'São José dos Campos', 'SP', 'ADMIN');
INSERT INTO tb_users(name, email, phone, birth_date, password, cpf_cnpj, zip_code, street, number, district, city, uf, role) VALUES ('João', 'joao@email.com', '11965985748', '2000-02-20', '123456', '73545687956', '35748000', 'Rua das Palmeiras', '456', 'Centro', 'São Paulo', 'SP', 'COMMON');
INSERT INTO tb_users(name, email, phone, birth_date, password, cpf_cnpj, zip_code, street, number, district, city, uf, role) VALUES ('Maria', 'maria@email.com', '1284754165', '1985-05-29', '123456', '32198765452', '12345678', 'Rua das Avenidas', '789', 'Centro', 'São Bernardo do Campo', 'SP', 'COMMON');
